...
function getCurrency(currency, wallet, providerUrl, contractAddress) {
    switch (currency) {
        case "arweave":
            return new arweave_1.default({ name: "arweave", ticker: "AR", minConfirm: 10, providerUrl: providerUrl !== null && providerUrl !== void 0 ? providerUrl : "https://arweave.net", wallet, isSlow: true });
        case "ethereum":
